...
if(blockName) {
  ...
  let dirPath = '../_source_dev/less/blocks/';  // полный путь к папке для блоков
  ...
  defaultExtensions.forEach(function(extention){
    ...
    let connectManagerPath = '../_source_dev/less/style.less';
    ...
    // Если это LESS
    if(extention == 'less') {
      styleFileImport = '@import \'./../_source_dev/less/blocks/' + blockName + '.less\';';
