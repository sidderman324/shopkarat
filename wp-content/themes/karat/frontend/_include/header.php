	...
	<div class="container">
		...
		<div class="middle_menu_block">
			<div class="row">
				...
				<div class="lk_block">
					...
					<a href="#" class="lk_link js-open-registration">Регистрация</a>

					<a href="#" class="lk_link js-open-login">Вход</a>

					<a href="#" class="btn btn--black">Личный кабинет</a>
		...
		<div class="bottom_menu_block">
			<ul class="icon_menu">
				...
				<li>
					<a href="#">
						<span class="icon icon--11111"></span>
