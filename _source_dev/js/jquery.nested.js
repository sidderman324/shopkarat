    ...
    $.Nested.prototype = {
        ...
        _setBoxes: function ($els, method) {
            ...
            $.each($els, function () {
                ...
                // var x = $(this).attr('data-detail-length');
                // var y = $(this).attr('data-detail-width');

                // var currWidth = (x * plateWidth / parseInt(cuttingSize[0])) * 1.011475;
                // var currHeight = (y * plateHeight / parseInt(cuttingSize[1])) * 1.011475;

                var currWidth = $(this).attr('data-px-length');
                var currHeight = $(this).attr('data-px-width');
        ...
        _renderItems: function ($els) {
            ...
            if (this._setHeight($els) >= plateHeight * currentCount) {
                console.log('new plate');
                currentCount++;
            }
            console.log(currentCount)
            $('#platesCount').attr('value', currentCount);
